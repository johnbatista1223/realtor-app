    ...
    return (
      <div className="for-sale">
        ...
        <section className="search-area">
          <input type="text" name="search" placeholder="Search here..." onChange={(e) => { setSearchField(e.target.value)}} value={searchField} />
          <button onClick={search}>SEARCH</button>
        </section>
          <div className="listing-results-wrapper">
          {listings.map((listing, index) => {
            return <ListingEntry key={listing} listing={listing} />
          })}
          </div>
